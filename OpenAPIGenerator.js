let fs = require("fs");
let License = require("./blobs/License");
let Info = require("./blobs/Info");
let Entity = require("./blobs/Entity");
let Swagger = require("./blobs/Swagger");
let Tag = require("./blobs/Tag");
let Definition = require("./blobs/Definition");
let Property = require("./blobs/Property");
...
class OpenAPIGenerator {
    ...
    process() {
        ...
        for(let tag of this.config.tags) {
